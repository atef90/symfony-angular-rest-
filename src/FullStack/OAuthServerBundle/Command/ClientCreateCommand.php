...
namespace FullStack\OAuthServerBundle\Command;
...
class ClientCreateCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln(sprintf('Added a new client with name <info>%s</info> and public id <info>%s</info>.', $client->getPublicId()));
    }
}